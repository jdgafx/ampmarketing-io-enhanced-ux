...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://ampmarketing-io-enhanced-ux.netlify.app/pricing",
  },
};
...
const faqs = [
  { question: "What do I get in the free trial?", answer: "Full access to everything for 7 days. No credit card required, no catches. Try it out, and if it's not for you, walk away. Zero hassle." },
  { question: "Can you make it fit my business?", answer: "Everything is built specifically for your business. Chatbot scripts, emails, ads—none of it is copy-paste. We keep refining until it sounds like you." },
  { question: "What if I want to change plans?", answer: "Upgrade when you're ready to grow, downgrade during slower months. We adjust your billing accordingly. No fees, no hassle." },
  { question: "What if none of the plans are right for me?", answer: "We'll build a custom plan. Tell us what you need, and we'll put together a package that fits your situation." },
  { question: "How quickly will this actually work?", answer: "Depends on the service. Chatbots can start capturing leads on day one. SEO takes a few months to build momentum. Most clients see noticeable results within the first week or two." },
  { question: "Do I have to sign a long contract?", answer: "Month-to-month billing. If you want to cancel, give us 30 days notice. No long-term contracts, no traps." }
];

const tableRows: Array<{ feature: string; starter: boolean | string; pro: boolean | string; enterprise: boolean | string }> = [
    ...
    <>
      ...
      <header className="svc-hero">
        <div className="shell">
          ...
          <div className="fade-up" style={{ animationDelay: '0.18s', marginTop: '24px' }}>
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', letterSpacing: '0.06em', color: 'var(--amp-primary)', padding: '4px 12px', border: '1px solid var(--amp-primary)', borderRadius: '12px' }}>
          ...
          <div data-reveal style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', alignItems: 'start', marginTop: '48px' }}>
            {platformTiers.map((tier, idx) => (
              ...
              >
                ...
                <div className="price">
                  from <em>${tier.annualPrice}</em>/mo
                </div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: '12px', color: 'var(--amp-muted)', marginBottom: '12px', letterSpacing: '0.03em' }}>
                  or ${tier.monthlyPrice}/mo billed monthly
                </div>
